function [S,GAMMA,PP,PS,N1,N2,N3,N5,N6] = dfbSimulation2(Pp,P0)
% Function dfbSimulation2 compute the DFB fibre laser internal gain, pump
% power and laser power distribution for given pump and laser powers
% 
% 
% Inputs:
%  - Pp:Pump power 
...
%   by a numerical iterative method including cooperative upconversion
%
% References: 
%  
...
N1 = zeros(1,100);
for ii=1:M
    [n1,n2,n3,n5,n6,Gamma,alpha] = rateEquationPairedSolver(Pp,Ps);
