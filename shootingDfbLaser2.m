function [S,Ps] = shootingDfbLaser2(Pp)
% ShootingDfbLaser2 function computes the output power of a DFB fibre laser
...
% Comments:
%   - The function calls the function dfbSimulation2
%   - The function " dfbSimulation2" is called multiple time to compute
...
%
% Initial condition to initiate the shooting algorithm
P01 = 1e-3;
P02 = 10e-3;
%
%
...
ii = 1;
S1 = dfbSimulation2(Pp,P01); % final backward propagation wave for initial guess P01
S2 = dfbSimulation2(Pp,P02); % final backward propagation wave for initial guess P02
...
S = S2;
Ps = abs(P02);
[S,GAMMA,PP,PS,N1,N2,N3,N5,N6] = feval('dfbSimulation2',Pp,Ps);
z = linspace(0,L);
figure(1)
subplot(2,2,1)
